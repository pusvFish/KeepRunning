...
void GameObjMap::onEnter(){
   ...
   // stars2 = CCArray::create(5);
    ...
    for(int i = 0;i < 5;i ++){
        GameObjStar* obj = GameObjStar::create();
        obj->setPosition(ccp(172 + 192 * i,350));
        stars1.push_back(obj);
        bg1->addChild(obj,3);

        GameObjStar*  obj2 = GameObjStar::create();
        obj2->setPosition(ccp(172 + 192 * i,350));
        stars2.push_back(obj2);
        bg2->addChild(obj2,3);
    }
